...
// amznmod_codegen: Add BigInt type to schema
export interface NativeModuleBigIntTypeAnnotation {
...
// amznmod_codegen: Add UInt32 type to schema
export interface NativeModuleUInt32TypeAnnotation {
  readonly type: 'UInt32TypeAnnotation';
}

// amznmod_codegen: Add Int64 type to schema
export interface NativeModuleInt64TypeAnnotation {
  readonly type: 'Int64TypeAnnotation';
}

// amznmod_codegen: Add ArrayBuffer type to schema
export interface NativeModuleArrayBufferTypeAnnotation {
  readonly type: 'ArrayBufferTypeAnnotation';
}

// amznmod_codegen: Add NativeObject type to schema
export interface NativeModuleNativeObjectTypeAnnotation {
  readonly type: 'NativeObjectTypeAnnotation';
}

// amznmod_codegen Add JSONContainer type to schema
export interface NativeModuleJSONContainerTypeAnnotation {
  readonly type: 'JSONContainerTypeAnnotation';
}
...
export type NativeModuleBaseTypeAnnotation =
  ...
  // amznmod_codegen: Add UInt32 type to schema
  | NativeModuleUInt32TypeAnnotation
  // amznmod_codegen: Add Int64 type to schema
  | NativeModuleInt64TypeAnnotation
  // amznmod_codegen: Add BigInt type to schema
  | NativeModuleBigIntTypeAnnotation
  // amznmod_codegen: Add ArrayBuffer type to schema
  | NativeModuleArrayBufferTypeAnnotation
  // amznmod_codegen: Add NativeObject type to schema
  | NativeModuleNativeObjectTypeAnnotation
  // amznmod_codegen: Add JSONContainer type to schema
  | NativeModuleJSONContainerTypeAnnotation

...
// amznmod_codegen: RN Codegen only allows interfaces named 'Spec'.
//                  Kepler Codegen should allow other names.
...
function throwIfArrayElementTypeAnnotationIsUnsupported(
  ...
  const TypeMap = {
    // amznmod_codegen: Removed the 'FunctionTypeAnnotation' as it is supported.
    VoidTypeAnnotation: 'void',
    PromiseTypeAnnotation: 'Promise',

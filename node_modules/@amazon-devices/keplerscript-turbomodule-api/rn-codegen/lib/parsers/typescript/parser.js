...
class TypeScriptParser {
  ...
  checkIfInvalidModule(typeArguments) {
    return (
      ...
      typeArguments.params[0].type !== 'TSTypeReference' // || amznmod_codegen: Allow non-'Spec' interface definitions
  ...
  isModuleInterface(node) {
    ...
    return (
      ...
      node.extends[0].expression.name === 'KeplerTurboModule' // amznmod_codegen: Support KeplerTurboModule instead of TurboModule
    );
  }

...
/**
 * CHANGELOG:
 * 97ce5dbe - Customize Kepler RN fork for apps to use
 * a482431d - Added attributions to modified react-native files
 * ae0d714 - Fix normalization of degrees in AnimatedInterpolation (Github PR # 36645)
 */
...
const useSingleOpBatching =
 // amznmod_react - accept kepler as platform.
  (Platform.OS === 'android' || Platform.OS === 'kepler') && 
...
function transformDataType(value: number | string): number | string {
  ...
  // amznmod_react -- Pre-emptively apply ae0d714 to fix native animation failure with radian rotation
  ...
  get nativeEventEmitter(): NativeEventEmitter {
    if (!nativeEventEmitter) {
      ...
      nativeEventEmitter = new NativeEventEmitter(
        ...
        // amznmod_react - As mentioned in above comment, our platform needs this, including it will call RCTDeviceEventEmitter::addListener
        (Platform.OS === 'ios' || Platform.OS === 'kepler') ? NativeAnimatedModule : null,
      );
    }

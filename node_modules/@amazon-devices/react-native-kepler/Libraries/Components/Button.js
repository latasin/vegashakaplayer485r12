 ...
 * 763b353f - Added ariaPosInSet, alexaEntityType, keplerAtlLabels, ariaLabel
...
// amznmod_react - add tagForComponentOrHandle
...
type ButtonProps = $ReadOnly<{|
  ...
  /**
    ...
    @platform android, tv
   */
  nextFocusDown?: ?(ElementRef<any> | number),
  ...
  /**
    ...
    @platform android, tv
   */
  nextFocusForward?: ?(ElementRef<any> | number),
  ...
  /**
    ...
    @platform android, tv
   */
  nextFocusLeft?: ?(ElementRef<any> | number),
  ...
  /**
    ...
    @platform android, tv
   */
  nextFocusRight?: ?(ElementRef<any> | number),
  ...
  /**
    ...
    @platform android, tv
   */
  nextFocusUp?: ?(ElementRef<any> | number),
  ...
  // amznmod_react: Add focusable actions
  /**
  ...
  /**
   * Callback that is called when the button is loses focus.
   */
  ...
  /**
   * amznmod_react - Add voiceOrdinal, used for ordinal selection for Voice Input
   */
  voiceOrdinal?: ?number,

  /**
   * amznmod_react - Add voiceEntityType, used to indicate the entity type of an element
   */
  voiceEntityType?: ?VoiceEntityTypeValue,

  /**
   * amznmod_react - Add voiceExternalIds, used to represent the external ids of an element
   */
  voiceExternalIds?: object,

  /**
   * amznmod_react - Add voiceAlternativeNames, used to provide the alternative names selectable by voice commands
   */
  ...
  /**
   * amznmod_react - Add ariaPosInSet, alias for voiceOrdinal, used for ordinal selection for Voice Input
   */
  ariaPosInSet?: ?number,

  /**
   * amznmod_react - Add alexaEntityType, alias for voiceEntityType, used to indicate the entity type of an element
   */
  alexaEntityType?: ?VoiceEntityTypeValue,

  /**
   * (Deprecated, use keplerAltLabels)
   * amznmod_react - Add keplerAtlLabels, alias for voiceAlternativeNames, used to provide the alternative names selectable by voice commands
   */
  ...
  /**
   * amznmod_react - Add ariaLabel, alias for accessibilityLabel used to indicate the element name
   */
  ariaLabel?: ?string,
  ...
  render(): React.Node {
    ...
    return (
      <Touchable
        ...
        // amznmod_react: provide backward compability to "ariaLabel(ariaLabelVoice) prop" (PROJVEGA-153671)
        accessibilityLabel={ariaLabelVoice || ariaLabel || accessibilityLabel}
        ...
        // amznmod_react: Add voiceOrdinal
        voiceOrdinal={voiceOrdinal}
        // amznmod_react: Add voiceEntityType
        voiceEntityType={voiceEntityType}
        // amznmod_react: Add voiceExternalIds
        voiceExternalIds={voiceExternalIds}
        // amznmod_react - Add voiceAlternativeNames
        voiceAlternativeNames={voiceAlternativeNames}
        // amznmod_react: Add ariaPosInSet
        ariaPosInSet={ariaPosInSet ?? voiceOrdinal}
        // amznmod_react: Add voiceEntityType
        alexaEntityType={alexaEntityType ?? voiceEntityType}
        // amznmod_react - Add keplerAtlLabels (backward compatibility for keplerAtlLabels)
        keplerAltLabels={keplerAltLabels ?? keplerAtlLabels ?? voiceAlternativeNames}
        // amznmod_react - Add alexaExternalIds
        alexaExternalIds={alexaExternalIds ?? voiceExternalIds}
        // amznmod_react - add enableSynchronousFocusEventsKepler
        enableSynchronousFocusEventsKepler={enableSynchronousFocusEventsKepler}
      >
...
// amznmod_react - adding kepler styles.
const styles = StyleSheet.create({

...
/**
 * @see DrawerLayoutKepler.kepler.js
 */
export interface DrawerLayoutKeplerProps extends ViewProps {
  /**
...
declare class DrawerLayoutKeplerComponent extends React.Component<DrawerLayoutKeplerProps> {}
declare const DrawerLayoutKeplerBase: Constructor<NativeMethods> &
  typeof DrawerLayoutKeplerComponent;
export class DrawerLayoutKepler extends DrawerLayoutKeplerBase {
  /**
   * drawer's positions.
   */

...
/**
 * Changelog:
 * - Adding ScrollViewPropsKepler (for scrollSlop)
 * - extend ScrollViewPropsKepler
 * - Add focusItemAlignment
 *
 */
...
//amznmod_react - Adding ScrollViewPropsKepler (for scrollSlop)
export interface ScrollViewPropsKepler {
  /**
   * This property specifies the current touch scroll slop. Scroll displacement
   * beyond this threshold only would result in scrolling on drag. The default is
   * 5 display pixels on the screen.
   *
   * @platform kepler
   */
  scrollSlop?: number;
...
export interface ScrollViewProps
  extends ViewProps,
    ...
    //amznmod_react - extend ScrollViewPropsKepler
    ScrollViewPropsKepler,
    Touchable {
  /**

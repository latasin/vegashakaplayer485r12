...
// amznmod_react - Add requestTVFocus method
...
> = React.forwardRef(
  (
    ...
    // amznmod_react - Add requestTVFocus method and over-write the render
    ...
    if (Platform.OS === 'kepler') {
      const focusableInternal = accessible || focusable;
      // amznmod_react: add accessibilityLabelledBy
      const _accessibilityLabelledBy =  ariaLabelledBy ?? accessibilityLabelledBy;
      return (
        <TextAncestor.Provider value={false}>
          <ViewNativeComponent
            {...otherProps}
            focusable={tabIndex !== undefined ? !tabIndex : focusableInternal}
      ...
      // amznmod_react: add accessibilityLabelledBy
      const _accessibilityLabelledBy = ariaLabelledBy?.split(/\s*,\s*/g) ?? accessibilityLabelledBy;

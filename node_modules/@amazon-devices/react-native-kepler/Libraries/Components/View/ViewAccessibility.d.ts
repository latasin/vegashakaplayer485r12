 ...
 *
 * Portions of this file are copyright (c) 2023 - 2024 Amazon.com, Inc. or its affiliates.  All rights reserved.
 *
...
/**
 * Changelog:
 * - Extends AccessibilityPropsKepler
 * - Add accessibilityDescribedBy, accessibilityOrientationText
...
export interface AccessibilityProps
  extends AccessibilityPropsAndroid,
    //amznmod_react - Extends AccessibilityPropsKepler
    AccessibilityPropsKepler,
...
// amznmod_react - Add AccessibilityPropsKepler
export interface AccessibilityPropsKepler {
  ...
  accessibilityDescribedByKepler?: string[] | undefined; // TODO: to be deprecated
   ...
   */
  accessibilityOrientationText?: string | undefined;
  accessibilityOrientationTextKepler?: string | undefined; // TODO: to be deprecated
   ...
   */
  transportControls?: TransportControls | undefined;
}

// amznmod_react - Add TransportControls
export interface TransportControls {
  /**
     * nativeID of the play button.
     */
  play?: string | undefined;
  /**
   * nativeID of the forward button.
   */
  forward?: string | undefined;
  /**
   * nativeID of the back button.
   */
  back?: string | undefined;
  /**
   * nativeID of the seekBar.
   */
  seekBar?: string | undefined;
}

// amznmod_react - Created VoiceProps and a VoiceEntityTypeValue for props relates to the voice usage
export type VoiceEntityTypeValue =
    | 'VideoObject'
    | 'ItemList'
    | 'SoftwareApplication'
    | 'Thing';
...
interface VoiceProps {
  ...
  // amznmod_react - Add keplerAtlLabels

 ...
 * Added isFocusableInTouchMode
 * Added VoiceOrdinal, VoiceExternalIds, VoiceEntityTypes, VoicePreferredNames
 * Added accessibilityDescribedBy, accessibilityOrientationText
 * Added transportControls
...
import type {
  ...
  AccessibilityRole,
  AccessibilityState,
  TransportControls, // amznmod_react - Add TransportControls
  AccessibilityValue,
...
type AndroidViewProps = $ReadOnly<{|
  ...
  /**
   * Whether this view is focusable in Touch mode
   *
   * @platform android
   */
...
export type ViewProps = $ReadOnly<{|
  ...
  /**
   * transportControls provide information on which elements are used to control the video player.
   */
  ...
  // amznmod_react - add accessibilityDescribedBy
  /**
   * accessibilityDescribedBy property provides the IDs of elements which describes this element.
   */
  ...
  // amznmod_react - add accessibilityOrientationText
  /**
   * accessibilityOrientationText provides the overview of how the layout is currently oriented to give the customer information on how to interact with it.
   */
  ...
  /**
   * Indicates whether onPress handlers are registered.
   *
   */
  isPressable?: ?boolean,
  ...
  /**
   * Indicates whether onLongPress handler is registered.
   *
   */
  ...
  /*
   * Indicate the number used for voice ordinal selection.
   * Note: This is the prop planned to deprecate.
   * Keep it for backward compatibility purpose.
   * Please use "ariaPosInSet" for future development.
   */
  voiceOrdinal?: ?number,

  // amznmod_react - Add voiceEntityType
  /*
   * Indicate the Alexa entity type for the UIElement
   * Note: This is the prop planned to deprecate.
   * Keep it for backward compatibility purpose.
   * Please use "alexaEntityType" for future development.
   */
  ...
  /*
   * Used to provide the alternative names selectable by voice commands
   * Note: This is the prop planned to deprecate.
   * Keep it for backward compatibility purpose.
   * Please use "keplerAltabels" for future development.
   */
  voiceAlternativeNames?: ReadonlyArray<string> | null | undefined,

  // amznmod_react - Add keplerAtlLabels (Deprecated, use keplerAltLabels)
  /**
   * Alias for voiceAlternativeNames, used to provide the alternative names selectable by voice commands
   */
  keplerAtlLabels?: ReadonlyArray<string> | null | undefined,

  // amznmod_react - Add keplerAltLabels
  /**
   * Alias for voiceAlternativeNames, used to provide the alternative names selectable by voice commands
   */
  keplerAltLabels?: ReadonlyArray<string> | null | undefined,

  // amznmod_react - Add alexaExternalIds
  /**
  * Alias for voiceExternalIds, used to represent the external ids of an element
  */
  alexaExternalIds?: Object,

  // amznmod_react - Add ariaLabel
  /**
   * Alias for accessibilityValue.text, used to indicate the element name
   */
  ariaLabel?: ?string,

  // amznmod_react - Add ariaPosInSet
  /**
   * Alias for voiceOrdinal, used for ordinal selection for Voice Input
   */
  ariaPosInSet?: ?number,

  // amznmod_react - Add alexaEntityType
  /**
   * Alias for voiceEntityType, indicate the Alexa entity type for the UIElement
   */
   ...
   * On Kepler, this can increase performance in animations and interactions that modify opacity, rotation and/or translation.
   * The downside is that this can use up memory, so it is recommended that this prop be set back to false at the end of the interaction/animation.
   */
  renderToHardwareTextureKepler?: ?boolean,

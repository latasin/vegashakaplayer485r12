...
import {default as NativeExceptionsManager} from "./NativeExceptionsManager";
...
function reportException(
  ...
  if (__DEV__) {
    ...
    // amznmod_react - generate ACR on fatal exception for Kepler platform 
    if (Platform.OS === 'kepler' && (isFatal || e.type !== 'warn')) {

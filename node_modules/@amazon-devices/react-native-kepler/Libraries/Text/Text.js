...
// amznmod_react Add LongPressEvent
import {
  AccessibilityRole,
  LongPressEvent,
...
> = React.forwardRef((props: TextProps, forwardedRef) => {
    ...
    () =>
      eventHandlers == null
        ...
        : {
            ...
            // amznmod_react Add LongPressEvent
            onLongPressEvent(event: PressEvent) {
              eventHandlers.onLongPressEvent(event);
  ...
  return hasTextAncestor ? (
    <NativeVirtualText
      ...
      voiceOrdinal={props.voiceOrdinal}
      // amznmod_react - add VoiceEntityType
      voiceEntityType={props.voiceEntityType}
      // amznmod_react - add VoiceExternalIds
      voiceExternalIds={props.voiceExternalIds}
      // amznmod_react - add voiceAlternativeNames
      voiceAlternativeNames={props.voiceAlternativeNames}
      // amznmod_react - add ariaPosInSet
      ariaPosInSet={props.ariaPosInSet ?? props.voiceOrdinal}
      // amznmod_react - add alexaEntityType
      alexaEntityType={props.alexaEntityType ?? props.voiceEntityType}
      // amznmod_react - add keplerAtlLabels, rename keplerAtlLabels to keplerAltLabels
      keplerAltLabels={props.keplerAltLabels ?? props.keplerAtlLabels ?? props.voiceAlternativeNames}
      // amznmod_react - Add alexaExternalIds
      alexaExternalIds={props.alexaExternalIds ?? props.voiceExternalIds}
    />
  ) : (

...
import { AudioContentType, AudioUsageType } from "./MediaTypes";
 ...
 *
 */
export declare class AudioPlayer extends MediaPlayer {
    /**
     * @brief Creates a `AudioPlayer` instance.
     * @param audioType Type of audio to play.
     * @param audioUsage  Reason for audio playback.
     */
    constructor(audioType?: AudioContentType, audioUsage?: AudioUsageType);
    /**

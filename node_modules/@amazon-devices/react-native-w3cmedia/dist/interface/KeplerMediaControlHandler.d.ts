import { Action, ICommandContext, RepeatMode, IMediaSessionId, IMediaMetadata, MediaSessionState, ITimeValue, ITrack } from '@amazon-devices/kepler-media-controls';
...
import { MediaControlHandler } from '../mediacontrolhandler/MediaControlHandler';
export declare class KeplerMediaControlHandler extends MediaControlHandler implements IMediaControlHandlerAsync {
    /**

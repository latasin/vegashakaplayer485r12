import { NativeClient } from './turbo-modules/KeplerMediaControlsClientTM';
import * as MediaControlTypes from './turbo-modules/types';
 ...
 */
export declare class MediaControlClientAsync implements MediaControlTypes.IMediaControlClientAsync {
    readonly client: NativeClient;
    readonly emptySession: MediaControlTypes.IMediaSessionId;
     ...
     */
    getEndpointPackageId(): MediaControlTypes.IPackageId;
    /**
     ...
     */
    play(session?: MediaControlTypes.IMediaSessionId): Promise<void>;
    /**
     ...
     * request, and rejects with an error otherwise
     */
    pause(session?: MediaControlTypes.IMediaSessionId): Promise<void>;
    /**
     ...
     * request, and rejects with an error otherwise
     */
    togglePlayPause(session?: MediaControlTypes.IMediaSessionId): Promise<void>;
    /**
     ...
     * request, and rejects with an error otherwise
     */
    stop(session?: MediaControlTypes.IMediaSessionId): Promise<void>;
    /**
     ...
     * request, and rejects with an error otherwise
     */
    startOver(session?: MediaControlTypes.IMediaSessionId): Promise<void>;
    /**
     ...
     * request, and rejects with an error otherwise
     */
    fastForward(session?: MediaControlTypes.IMediaSessionId): Promise<void>;
    /**
     ...
     * request, and rejects with an error otherwise
     */
    rewind(session?: MediaControlTypes.IMediaSessionId): Promise<void>;
    /**
     ...
     * request, and rejects with an error otherwise
     */
    setPlaybackSpeed(speed: number, session?: MediaControlTypes.IMediaSessionId): Promise<void>;
    /**
     ...
     * request, and rejects with an error otherwise
     */
    skipForward(delta: MediaControlTypes.ITimeValue, session?: MediaControlTypes.IMediaSessionId): Promise<void>;
    /**
     ...
     * request, and rejects with an error otherwise
     */
    skipBackward(delta: MediaControlTypes.ITimeValue, session?: MediaControlTypes.IMediaSessionId): Promise<void>;
    /**
     ...
     * request, and rejects with an error otherwise
     */
    seek(position: MediaControlTypes.ITimeValue, session?: MediaControlTypes.IMediaSessionId): Promise<void>;
    /**
     ...
     * request, and rejects with an error otherwise
     */
    setAudioVolume(volume: number, session?: MediaControlTypes.IMediaSessionId): Promise<void>;
    /**
     ...
     * request, and rejects with an error otherwise
     */
    setAudioTrack(audioTrack: MediaControlTypes.ITrack, session?: MediaControlTypes.IMediaSessionId): Promise<void>;
    /**
     ...
     * request, and rejects with an error otherwise
     */
    enableTextTrack(textTrack: MediaControlTypes.ITrack, session?: MediaControlTypes.IMediaSessionId): Promise<void>;
    /**
     ...
     * request, and rejects with an error otherwise
     */
    disableTextTrack(session?: MediaControlTypes.IMediaSessionId): Promise<void>;
    /**
     ...
     * request, and rejects with an error otherwise
     */
    next(session?: MediaControlTypes.IMediaSessionId): Promise<void>;
    /**
     ...
     * request, and rejects with an error otherwise
     */
    previous(session?: MediaControlTypes.IMediaSessionId): Promise<void>;
    /**
     ...
     * request, and rejects with an error otherwise
     */
    enableShuffle(enable: boolean, session?: MediaControlTypes.IMediaSessionId): Promise<void>;
    /**
     ...
     * request, and rejects with an error otherwise
     */
    setRepeatMode(mode: MediaControlTypes.RepeatMode, session?: MediaControlTypes.IMediaSessionId): Promise<void>;
    /**
     ...
     * request, and rejects with an error otherwise
     */
    setRating(id: MediaId, rating: number, session?: MediaControlTypes.IMediaSessionId): Promise<void>;
    /**
     ...
     */
    getMetadata(id: MediaId): Promise<MediaControlTypes.IMediaMetadata>;
    /**
     * Send a start over request to this media control endpoint
     ...
     * request, and rejects with an error otherwise
     */
    sendCustomAction(action: MediaControlTypes.Action, session?: MediaControlTypes.IMediaSessionId): Promise<void>;
    /**
     ...
     */
    getSessionState(session?: MediaControlTypes.IMediaSessionId): Promise<MediaControlTypes.MediaSessionState[]>;
    /**
     ...
     */
    addListener(listener: MediaControlTypes.IMediaControlListener): Promise<MediaControlTypes.ISubscription>;
    /**

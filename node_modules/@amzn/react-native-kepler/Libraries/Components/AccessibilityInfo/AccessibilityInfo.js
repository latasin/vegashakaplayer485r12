...
const AccessibilityInfo = {
  ...
  isBoldTextEnabled(): Promise<boolean> {
    //amznmod_react - kepler platform support
  ...
  addEventListener<K: $Keys<AccessibilityEventDefinitions>>(
    ...
    if (deviceEventName == null) {
      ...
      return NativeAccessibilityInfoAndroid.addListener(
        deviceEventName,
        handler,
      );
    } else {
      return RCTDeviceEventEmitter.addListener(deviceEventName, handler);
    }
  },
  ...
  announceForAccessibilityWithOptions(
    ...
    if (Platform.OS === 'kepler') {
      NativeAccessibilityInfoAndroid?.announceForAccessibilityWithOptions(announcement, options?.queue == true);

...
/**
 * Changelog:
 * - Add pin to KeyboardTypeKepler
 * - Include KeyboardTypeKepler
 * - Add auxOptions
 * - Add submitAction
 * - Add keyboardUiMode
 */
...
// amznmod_react Add Int32 import. Fails with '../../Types/CodegenTypes'
...
// amznmod_react - Add pin to KeyboardTypeKepler
export type KeyboardTypeKepler = 'pin';

// amznmod_react - Include KeyboardTypeKepler
...
// amznmod_react - Include KeyboardUiMode
export type KeyboardUiMode = 'system-default' | 'half-screen' | 'full-screen' | 'floating';
...
export type SubmitActionType = ReturnKeyTypeOptions | 'hide_password' | 'show_password' | 'disabled' | 'cancel' | Int32;
...
export interface TextInputAndroidProps {
  ...
  /**
   * Sets the rows of lines for a TextInput.
   * Use it with multiline set to true to be able to fill the lines.
   */
...
export interface TextInputProps
  ...
  // amznmod_react - Add underlineColorKepler
  /**
   * The color of the textInput underline (Kepler).
   */
  underlineColorKepler?: ColorValue | null | undefined;

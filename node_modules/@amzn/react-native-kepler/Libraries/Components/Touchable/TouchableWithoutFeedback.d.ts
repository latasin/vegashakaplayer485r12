...
/**
 * Changelog:
 * - Extends TouchableWithoutFeedbackPropsKepler
 * - Add isFocusableInTouchMode
 * - Add enableSynchronousFocusEventsKepler
 * - Add types - nativeID and accessibilityDescribedBy
 */
...
// amznmod_react - TouchableWithoutFeedbackPropsKepler
export interface TouchableWithoutFeedbackPropsKepler {
...
export interface TouchableWithoutFeedbackProps
  extends TouchableWithoutFeedbackPropsIOS,
    ...
    // amznmod_react - Extends TouchableWithoutFeedbackPropsKepler
    TouchableWithoutFeedbackPropsKepler,
    AccessibilityProps {
  ...
  /**
   *
   * @deprecated use accessibilityDescribedBy instead
   */
  accessibilityDescribedByKepler?: string[]; // TODO: to be deprecated

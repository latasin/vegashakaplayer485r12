...
/**
 * CHANGELOG:
 * Added voiceOrdinal, voiceEntityType, voiceExternalIds, voiceAlternativeNames
...
const ReactNativeViewConfig: ViewConfig = {
  ...
  directEventTypes: {
    ...
    // amznmod_react Add LongPress Event
    topLongPress: {
  ...
  validAttributes: {
    ...
    style: {
      ...
      defaultColor: {process: require('../../StyleSheet/processColor')},
      padding: true,
      paddingBottom: true,
      paddingEnd: true,
      paddingHorizontal: true,

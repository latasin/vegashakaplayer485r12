...
//amznmod_react - Support variadic args.
else {
  global.setTimeout = (cb, delay = 0, ...args) => {
    ...
    return global.__setTimeoutInternal__(cb, delay, argsArr);
  };
  global.setImmediate = (cb, ...args) => {
    ...
    return global.__setImmediateInternal__(cb, argsArr);
  };
  global.setInterval = (cb, delay = 0, ...args) => {
    ...
    return global.__setIntervalInternal__(cb, delay, argsArr);
  };
  global.requestIdleCallback = (cb) => {
    return global.__requestIdleCallback__(cb);
  };
}
//amznmod_react
/**

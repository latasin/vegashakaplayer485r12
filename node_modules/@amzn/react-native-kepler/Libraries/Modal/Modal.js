...
// amznmod_react - adding support for kepler
const isNativeEventEmitterSupportedPlatform =
    Platform.OS === 'ios' || Platform.OS === 'kepler';
const ModalEventEmitter =
    isNativeEventEmitterSupportedPlatform && NativeModalManager != null
    ? new NativeEventEmitter<ModalEventDefinitions>(
        // T88715063: NativeEventEmitter only used this parameter on iOS. Now it uses it on all platforms, so this code was modified automatically to preserve its behavior
        // If you want to use the native module on other platforms, please remove this condition and test its behavior
        !isNativeEventEmitterSupportedPlatform ? null : NativeModalManager,
      )
    : null;

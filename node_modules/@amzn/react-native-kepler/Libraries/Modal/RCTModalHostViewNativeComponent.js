...
const ModalHostViewComponent = 'ModalHostView';

registerGeneratedViewConfig(ModalHostViewComponent,
    {
      uiViewClassName: ModalHostViewComponent,
      bubblingEventTypes: {},
      directEventTypes: {
        topShow: {
...
export default ((ModalHostViewComponent: any): HostComponent<NativeProps>);

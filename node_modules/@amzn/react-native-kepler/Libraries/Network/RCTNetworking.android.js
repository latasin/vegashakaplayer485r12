...
// amznmod_react - add KeplerEventSubscription
import NativeEventSubscription from './NativeNetworkingAndroid';
...
class RCTNetworking extends NativeEventEmitter<$FlowFixMe> {
  ...
  // amznmod_react - return KeplerEventSubscription
  addListener(eventType, listener, context) {
    const nativeEventSubscription = NativeNetworkingAndroid.addListener(eventType, listener);

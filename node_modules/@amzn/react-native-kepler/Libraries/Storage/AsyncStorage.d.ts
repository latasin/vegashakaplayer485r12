/**
 * amznmod_react: This file was RE-INCLUDED because Keplerscript has not removed
 *                async storage. React-native has pushed maintenance of this file
 *                to a community package. As a result, we must maintain the types.
 *
...
export interface AsyncStorageStatic {
    ...
    /**
     * Delete all keys in the store that begin with a specified prefix.
     * Optional - Check if defined before calling.
     */
    removeValuesForKeysWithPrefix?(prefix: string, callback?: (errors?: Error[]) => void): Promise<void>;

...
export interface TextPropsAndroid {
  ...
  // amznmod_react Add selected prop for Text
  // https://developer.android.com/reference/android/view/View#setSelected(boolean)
  /**
   * Lets the user to mark the state of the text as selected
   */
...
export interface TextProps
   ...
   * - `marquee` - If the text content exceeds the width of the text container, the text will scroll
   * horizontally in a "marquee" effect to display the hidden content. 
   * The default is `tail`.
   *
   * `numberOfLines` must be set in conjunction with this prop.
   * > `marquee` is available only on kepler platform. 
   * > `clip` is working only for iOS
   */
  ellipsizeMode?: 'head' | 'middle' | 'tail' | 'clip' | 'marquee' | undefined;

...
class WebSocket extends (EventTarget(...WEBSOCKET_EVENTS): typeof EventTarget) {
  ...
  _registerEvents(): void {
    this._subscriptions = [
      NativeWebSocketModule.addListener('websocketMessage', ev => {
      ...
      NativeWebSocketModule.addListener('websocketOpen', ev => {
        if (ev.id !== this._socketId) {
          return;
        }
      ...
      NativeWebSocketModule.addListener('websocketClosed', ev => {
        if (ev.id !== this._socketId) {
          return;
        }
      ...
      NativeWebSocketModule.addListener('websocketFailed', ev => {
        if (ev.id !== this._socketId) {
          return;
        }
        this.readyState = this.CLOSED;

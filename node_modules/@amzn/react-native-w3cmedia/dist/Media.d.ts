 ...
 */
export declare class Media<P, S> extends React.Component<P & MediaProps & ViewProps, S & MediaState> implements HTMLMediaElement {
    protected mediaPlayer_: MediaPlayer | null;
    private controls_;
    protected captionsViewHandle_: string | null;
    constructor(props: P & MediaProps & ViewProps, mediaPlayer: MediaPlayer);
    /**
     * @hidden
     */
    protected destroyMediaPlayer(): Promise<void>;
    /**
     * @hidden
     */
    protected destroyMediaPlayerSync(timeoutInMs: number): MediaPlayerDeInitStatus;
    /**
     * @hidden
     */
    ...
    */
     ...
     */
    private setupEventListenersFromProps;
    /**
     * @hidden
     * Reset event listeners passed in props before destroy
     */
    private resetEventListenersFromProps;
    /**
     * @hidden
     * uses properties to set the attributes of the class that triggers setter functions.
     * (except for control prop)
     */
    protected setupProps(): void;
    protected onMediaPlayerInitialized(): void;
    /**
     * @hidden
     */
    protected initializeMediaPlayer(): Promise<void>;
    /**
     ...
     */
    protected setMediaControlFocus(componentInstance: IComponentInstance, mediaControlHandler?: IMediaControlHandlerAsync): Promise<void>;
    /**
     * @hidden
     */

import { Action, ICommandContext, RepeatMode, IMediaSessionId, IMediaMetadata, MediaSessionState, ITimeValue, ITrack } from '@amzn/kepler-media-controls';
import { IMediaControlHandlerAsync } from '@amzn/kepler-media-controls';
import { MediaPlayer } from '../MediaPlayer';
import { MediaId } from '@amzn/kepler-media-types';
export declare class MediaControlHandler implements IMediaControlHandlerAsync {
     ...
     */
    getRepeatModeString(repeatMode: RepeatMode): "OFF" | "REPEAT_PLAYLIST" | "REPEAT_TRACK" | "BAD_VALUE";
    /**
     * @hidden
